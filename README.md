...
全ての出題が終了すると、結果が表示され、自動的に履歴が保存されます。この履歴は、**履歴表示**から閲覧することができます。

> [!NOTE]
> セッション中に出題を中止する場合は、(KeyboardInterruptせず) `/exit` と入力することで履歴を保存しながら安全に終了することができます。

---

### 履歴表示

セッションの履歴を確認することができます。履歴は月ごとに表示されます。
確認できる内容は以下の通りです。
